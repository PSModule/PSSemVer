...
- [`README.md`](README.md) — what this repository is and what the module does.
- [`CONTRIBUTING.md`](CONTRIBUTING.md) — how to contribute to this repository.
- [Semantic Versioning 2.0.0](https://semver.org/) — the specification this module implements.
...
- [Repository defaults](https://psmodule.io/Process-PSModule/) — the expected repository layout and required files.
- [Module anatomy](https://psmodule.io/Process-PSModule/) — source layout and framework conventions.
- [Build, test, pack, publish](https://psmodule.io/Process-PSModule/) — the CI/CD pipeline.
- [Standards](https://psmodule.io/Process-PSModule/) — PowerShell module coding standards.
